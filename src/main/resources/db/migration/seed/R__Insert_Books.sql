...
values ('1', 'Tale of two cities', 'Charles Dickens', '350',
       ...
       ('2', 'Little women', 'Louisa May Alcott', '450',
       ...
       ('3', 'How to stop worrying and start living', 'Dale Carnegie', '550',
       ...
       ('4', 'Atomic Habits', 'James Clear', '300',
       ...
       ('5', 'Courage to be disliked', 'Ichiro Kishimi', '250',
